...
class PracticeResponse extends Component {
  ...
  handleFlip = () => {
    ...
    if (textInput) dispatch(handleSubmitRoundCheck(goalId, interactionId, answer ));
  };
            ...
            <div className="detail-buttons">
              <div>
                <button
                  ...
                  onClick={() =>
                    this.handleSubmit(interaction, true)
                  }
                >
                  Correct!
                </button>
              ...
              <div>
                <button
                  ...
                  onClick={() =>
                    this.handleSubmit(interaction, false)
                  }
                >
                  Incorrect
                </button>
...
const mapStateToProps = ({ selections, round }, {interaction, current, totalCards}) => {
